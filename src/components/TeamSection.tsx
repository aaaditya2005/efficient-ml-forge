...
const TeamSection = () => {
  ...
  return <section id="team" className="py-20 md:py-32 relative">
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="final" className="max-w-6xl mx-auto">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-3 mb-12 bg-muted/50 h-auto p-1">
            <TabsTrigger value="final" className="py-2.5 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md">
              Final Year
            </TabsTrigger>
            <TabsTrigger value="prefinal" className="py-2.5 data-[state=active]:bg-secondary data-[state=active]:text-secondary-foreground data-[state=active]:shadow-md">
              Pre-Final Year
            </TabsTrigger>
            <TabsTrigger value="second" className="py-2.5 data-[state=active]:bg-accent data-[state=active]:text-accent-foreground data-[state=active]:shadow-md">
              Second Year
            </TabsTrigger>
          </TabsList>

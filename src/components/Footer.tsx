...
const Footer = () => {
  ...
  return <footer className="bg-card/50 border-t border-border/50 py-12 md:py-16">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {quickLinks.map(link => <li key={link.label}>
                  <button onClick={() => scrollToSection(link.href)} className="text-muted-foreground hover:text-primary transition-colors text-sm">
                    {link.label}
                  </button>
                </li>)}
            </ul>
        ...
        <div className="border-t border-border/50 pt-8 mb-8">
          <div className="glass-card rounded-xl p-6 max-w-3xl mx-auto text-center">
            ...
            <a href="https://www.instagram.com/rnd_cca.nitd?igsh=MTU2ZWtydDFvb3Vvbw==" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-secondary text-primary-foreground px-6 py-2 rounded-full font-medium hover:opacity-90 transition-opacity">
